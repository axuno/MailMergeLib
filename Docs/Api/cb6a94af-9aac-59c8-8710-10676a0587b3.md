# HtmlBodyBuilderRegEx.DocBaseUrl Property 
 

Gets or sets the Base URL of the HTML document. This is used for building the path of embedded images.
...
**VB**<br />
``` VB
Public Property DocBaseUrl As String
	Get
	Set
```
