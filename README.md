...
### Release status
The binaries of release  version 5.0.0.100 can be found in folder "Binaries-Snapshot" for more easy evaluation.
Any reports on issues are appreciated.
...
MailMergeLib 5 published on GitHub is a major rewrite, and it is not backwards compatible to prior releases.
