namespace MailMergeLib.SmartFormatMail.Utilities
{
    public static class PluralRules_Old
    {
        ...
        public static int English_Special(decimal value, int pluralCount)
        {
            ...
            if (pluralCount == 2) return value == 1m ? 0 : 1;
            // Three forms (zero, one, plural)
            if (pluralCount == 3) return value == 0m ? 0 : value == 1m ? 1 : 2;
            // Four forms (negative, zero, one, plural)
            if (pluralCount == 4) return value < 0m ? 0 : value == 0m ? 1 : value == 1m ? 2 : 3;
        ...
        public static int French(decimal value, int pluralCount)
        {
            ...
            if (pluralCount == 2) return value == 0m || value == 1m ? 0 : 1;
            return -1;
        }
        ...
        public static int Latvian(decimal value, int pluralCount)
        {
            ...
            if (pluralCount == 3) return value % 10 == 1 && value % 100 != 11 ? 0 : value != 0 ? 1 : 2;
            return -1;
        }
        ...
        public static int Irish(decimal value, int pluralCount)
        {
            ...
            if (pluralCount == 3) return value == 1 ? 0 : value == 2 ? 1 : 2;
            return -1;
        }
        ...
        public static int Romanian(decimal value, int pluralCount)
        {
            ...
            if (pluralCount == 3) return value == 1m ? 0 : value == 0m || value % 100 > 0 && value % 100 < 20 ? 1 : 2;
            return -1;
        }
        ...
        public static int Czech(decimal value, int pluralCount)
        {
            ...
            if (pluralCount == 3) return value == 1 ? 0 : value >= 2 && value <= 4 ? 1 : 2;
            return -1;
        }
